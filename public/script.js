...
function displayProxyStats(proxyData) {
    ...
    if (proxyData.lastUpdate) {
        ...
        if (refreshElement) {
            refreshElement.textContent = `Last refresh: ${timeText}`;
        }
    }
...
function updateProxyCount(proxyData) {
    ...
    if (countElement) {
        countElement.textContent = `${totalProxies} active`;
    }
}
        ...
        <div class="modal-overlay" id="keywordModal">
            <div class="modal">
                ...
                <div class="modal-body">
                    ...
                    ` : '<p class="no-data">No keywords found</p>'}
    ...
    statusDiv.innerHTML = `
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
            ...
            <div style="text-align: center;">
                ...
                <div style="font-size: 1.3rem; font-weight: 700; color: #2c3e50;">
                    ${data.system?.memory?.heapUsed || 'N/A'}
                </div>
            </div>
            <div style="text-align: center;">
                <div style="font-size: 0.9rem; color: #7f8c8d;">Active Sessions</div>
                <div style="font-size: 1.3rem; font-weight: 700; color: #27ae60;">
                    ${data.sessions?.running || 0}/${data.sessions?.total || 0}
                </div>
            </div>
            <div style="text-align: center;">
